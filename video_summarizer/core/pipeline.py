...
class PipelineStage(ABC):
    ...
    def save_checkpoint(self, data: PipelineResult, checkpoint_dir: str) -> str:
        ...
        checkpoint_path = os.path.join(checkpoint_dir, f"{self.name}_checkpoint.json")
...
class Pipeline:
        ...
        try:
            for i, stage in enumerate(self.stages):
                ...
                if self.checkpoint_dir:
                    checkpoint_path = stage.save_checkpoint(data, self.checkpoint_dir)
    ...
    @classmethod
    def load_from_checkpoint(cls, checkpoint_path: str, stage_type: Type[PipelineStage]) -> PipelineResult:
