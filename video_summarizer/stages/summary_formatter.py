...
class SummaryFormatter(PipelineStage):
    ...
    def __init__(self, model: str = "gemini-2.0-flash",
                 max_tokens: int = 2000, output_dir: Optional[str] = None,
    ...
    def _generate_marp_deck(self, summary_content: str,
        ...
        try:
            ...
            formatted_text = formatted_text.replace("<!-- _class: front-page -->\n---","\n")
...
def create_summary_formatter(
        ...
        preferred_provider: str = "gemini") -> SummaryFormatter:
