...
def main():
    ...
    parser = argparse.ArgumentParser(description="Format summaries into Marp slide decks.")
    parser.add_argument("path", help="Path to a summary file or directory containing summary files")
    parser.add_argument("-o", "--output-dir", help="Directory to save formatted files")
    parser.add_argument("-p", "--provider", default="gemini", choices=["gemini", "anthropic", "openai"],
