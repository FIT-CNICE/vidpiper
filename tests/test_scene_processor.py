...
def test_scene_processor(test_video_path, test_output_dir):
    ...
    sample_scenes_file = os.path.join(test_output_dir, "scenes_threshold_30.0.json")
    ...
    processor = SceneProcessor(video_path=test_video_path, output_dir=processor_output_dir)
    ...
    for scene in processed_scenes:
        ...
        print(f"  Transcript: {scene.transcript[:50]}..." if len(scene.transcript or '') > 50 
