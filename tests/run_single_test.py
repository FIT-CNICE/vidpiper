...
def run_single_test(test_name, force=False):
    ...
    if not force and test_name != "scene_detector":
        if not get_test_stage_status(test_name):
            ...
            print("Run previous tests first or use --force to bypass dependency checking.")
            return 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("test_name", choices=["scene_detector", "scene_processor", "summary_generator"],
